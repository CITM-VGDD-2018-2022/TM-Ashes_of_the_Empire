...
The Mandalorian: Ashes of the Empire is a fast-paced roguelite with an emphasis on ranged combat and constant repositioning. The player controls Din Djarin, the Mandalorian. Readying himself before a crucial mission, Mando shares a drink with his allies in a canteen, remembering and retelling a past mission in which he took on a crusade against Moff Gideon.
...
When you start the run use the control keys below to navigate through the levels: shoot the enemies & advance through the levels grabbing the Boons!. Once you finished you can go back to the HUB & try again! In the HUB, you can open the Pause Menu at any time to save your progress.
...
- Mando has to option to perform a Dash:increasing your speed momentarily in the direction of your movement.
- Mando has to option to perform basic Shooting, Gadget Weapon Shooting & Sniper Charge Shooting.
...
- Polished behaviour of the character!
- HUD overhauled with full functionality. <br>
...
- Added 3 bosses encounters:
	- Rancor: 1st level boss,finished & polished.
...
- Polished (& remade some parts) 1st Level with final & Art Assets.
...
- Fully interactable Barrels & different kinds of Traps!
...
- Added fully functional interactive music!

### General Gameplay
- Perspective Camera for cinematics & Orthogonal Camera for Gameplay.
- Overhauled UI & HUD's design, functionality & art.
- Added combo system with UI (every time an enemy takes damage you get a combo counter that fades with time).
...
- Dialogue System: added dialogues that can be skipped by pressing A, at the start & the end of the run.
...
- Playtest document, sessions & analysis.
...
* [Vertical Slice 3](https://github.com/CITM-VGDD-2018-2022/TM-Ashes_of_the_Empire/releases/tag/v0.4)
